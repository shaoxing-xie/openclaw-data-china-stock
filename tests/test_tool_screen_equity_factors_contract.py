...
def test_tool_screen_by_factors_alias_matches(monkeypatch: pytest.MonkeyPatch) -> None:
    from plugins.analysis import equity_factor_screening as mod
    from plugins.analysis.sw_industry_mapping import load_sw_level1_mapping
    ...
    a = mod.tool_screen_equity_factors(**kwargs)
    b = mod.tool_screen_by_factors(**kwargs)
